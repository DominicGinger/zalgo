...
document.querySelector('body').addEventListener('paste', function (event) {
  ...
  str.split('').forEach(function (c) {
    return insertTextAtCursor(transformChar(c));
  });
});
...
document.querySelector('.output').addEventListener('keypress', function (event) {
  if (event.which === 13) {
    // Enter
    return;
  }
...
},{}],"../../.nodenv/versions/10.9.0/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../.nodenv/versions/10.9.0/lib/node_modules/parcel/src/builtins/hmr-runtime.js","index.js"], null)
//# sourceMappingURL=/zalgo.a827b5a5.map